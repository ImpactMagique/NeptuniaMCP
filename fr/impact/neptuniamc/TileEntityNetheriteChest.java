...
import fr.impact.neptuniamc.BlockNetheriteChest;
...
public class TileEntityNetheriteChest extends TileEntity implements IInventory
{
    private ItemStack[] field_145985_p;
    public boolean field_145984_a;
    public TileEntityNetheriteChest field_145992_i;
    public TileEntityNetheriteChest field_145990_j;
    public TileEntityNetheriteChest field_145991_k;
    public TileEntityNetheriteChest field_145988_l;
    ...
    public TileEntityNetheriteChest(int par1)
    {
        field_145985_p = new ItemStack[54];
    ...
    private void func_145978_a(TileEntityNetheriteChest p_145978_1_, int p_145978_2_)
    {
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        return var4 instanceof BlockNetheriteChest && ((BlockNetheriteChest)var4).field_149956_a == this.func_145980_j();
    }
    ...
    {
        if (this.getBlockType() instanceof BlockNetheriteChest)
        {
            --this.field_145987_o;
            this.worldObj.func_147452_c(this.field_145851_c, this.field_145848_d, this.field_145849_e, this.getBlockType(), 1, this.field_145987_o);
            this.worldObj.notifyBlocksOfNeighborChange(this.field_145851_c, this.field_145848_d, this.field_145849_e, this.getBlockType());
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockNetheriteChest))
            {
                return 0;
            }
 
            this.field_145982_r = ((BlockNetheriteChest)this.getBlockType()).field_149956_a;
        }
